...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top" >
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.html">{{$data->nome}}</a>
  ...
  <div class="intro intro-carousel swiper position-relative">
    ...
    <div class="swiper-wrapper">
      ...
      @foreach ($banner as $item)
        <div class="swiper-slide carousel-item-a intro-item bg-image" style="background-image: url('{{ asset('build/images/'. $item->image) }}')">
                  ...
                  <div class="col-lg-8">
                    <div class="intro-body">
                      ...
                      <h1 class="intro-title mb-4 ">
                        {{$item->titulo}} 
                        <br> <span class="color-b">SANTO ANTONIO</span>
                      </h1>
                      <p class="intro-subtitle intro-price">
                        <a href="#"><span class="price-a">{{$item->texto_botao}}</span></a>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-12">
            <div class="title-wrap d-flex justify-content-between">
              ...
              <div class="title-link">
                <a href="property-grid.html">Todas as Propriedades
                  <span class="bi bi-chevron-right"></span>
                </a>
              </div>
            </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="carousel-item-b swiper-slide">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{ asset('build/images/property-6.jpg') }}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="property-single.html">206 Minas Gerais
                          <br />Santa cruz</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a"><a href="#">Entrar em contato</a></span>
                      </div>
                      <a href="#" class="link-a">Clique aqui
                        <span class="bi bi-chevron-right"></span>
                      </a>
                    </div>
            ...
            <div class="carousel-item-b swiper-slide">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{ asset('build/images/property-3.jpg') }}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                    ...
                    <div class="card-body-a">
                      ...
                      <a href="property-single.html" class="link-a">Clique aqui
                        <span class="bi bi-chevron-right"></span>
                      </a>
                    </div>
                    <div class="card-footer-a">
            ...
            <div class="carousel-item-b swiper-slide">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{ asset('build/images/property-7.jpg') }}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
            ...
            <div class="carousel-item-b swiper-slide">
              <div class="card-box-a card-shadow">
                <div class="img-box-a">
                  <img src="{{ asset('build/images/property-10.jpg') }}" alt="" class="img-a img-fluid">
                </div>
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="testimonial-img">
                      <img src="{{ asset('build/images/testimonial-1') }}" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-6">
            ...
            <div class="carousel-item-a swiper-slide">
              <div class="testimonials-box">
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="testimonial-img">
                      <img src="{{ asset('build/images/testimonial-2.jpg') }}" alt="" class="img-fluid">
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-6">
                    <div class="testimonial-ico">
                    ...
                    <div class="testimonial-author-box">
                      <img src="{{ asset('build/images/mini-testimonial-1.jpg') }}" alt="" class="testimonial-avatar">
