        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">{{$propriedade->titulo}}</h1>
              <span class="color-text-a">{{$endereco->cidade}}/{{$endereco->estado}} - {{$endereco->bairro}}</span>
            </div>
          </div>
          <div class="col-md-12 col-lg-4">
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="{{ route('site-properte') }}">Propriedades</a>
                </li>
              ...
              <div class="swiper-wrapper">
                @foreach($imagens as $imagem)
                    <div class="carousel-item-b swiper-slide">
                        <img src="{{ $imagem }}" alt="Imagem da Propriedade" class="w-100">
                    </div>
                @endforeach
              </div>
            </div>
                  ...
                  <div class="summary-list">
                    <ul class="list">
                      ...
                      <li class="d-flex justify-content-between">
                        ...
                        <span>{{$propriedade->status}}</span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Area:</strong>
                        <span>{{$propriedade->area}}m
                          <sup>2</sup>
                        </span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Quartos:</strong>
                        <span>{{$propriedade->quarto}}</span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Banheiros:</strong>
                        <span>{{$propriedade->banheiro}}</span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Garagem:</strong>
                        <span>{{$propriedade->garagem}}</span>
                      </li>
                    </ul>
                  </div>
                </div>
