                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="<?php echo e(URL::asset('./images/logo.png')); ?>" alt="" height="80">
                            </a>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <div class="float-end">
                                            <a href="<?php echo e(route('password.update')); ?>" class="text-muted">Esqueceu sua senha?</a>
                                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> DSA SOFTWARE. Designer made by <a href="#">Leandro de oliveira</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TEMPLETE\resources\views/auth/login.blade.php ENDPATH**/ ?>