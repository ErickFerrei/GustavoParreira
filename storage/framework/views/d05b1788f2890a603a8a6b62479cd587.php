...
<?php $__env->slot('li_1'); ?> Criar <?php $__env->endSlot(); ?>
...
<div class="container">
    <div class="card">
        ...
        <form action="<?php echo e(route('banner-store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 d-flex gap-3">
                    ...
                    <a href="<?php echo e(route('banner-index')); ?>" class="btn rounded-pill btn-light waves-effect">Voltar</a>
                </div>
        ...
        <div class="py-3 d-flex justify-content-center col-md-8">
            <img class="" src="<?php echo e(asset('build/images/banner-exem.svg')); ?>" alt="" style="width: 500px">
        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TEMPLETE\resources\views/master/banner/create.blade.php ENDPATH**/ ?>